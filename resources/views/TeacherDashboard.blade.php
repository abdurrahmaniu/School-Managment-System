...
<div class="min-h-screen flex">
    <div class="py-12 px-10 w-1/4">
      <div class="flex space-2 items-center border-b-2 pb-4">
        ...
        <div class="ml-3">
          <h1 class="text-3xl font-bold text-indigo-600">TEACHERS</h1>
      ...
      <div class="mt-8">
        <ul class="space-y-10">
          ...
          <li>
            <a href="settingsa" class="flex items-center text-sm font-semibold text-gray-500 hover:text-indigo-600 transition duration-200" hover:text-indigo-600>
