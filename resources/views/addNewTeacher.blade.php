						...
						<div class="md:flex flex-row md:space-x-4 w-full text-xs">
							...
							<div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
								...
								<div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                    ...
                                    <div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                        <div class="w-full flex flex-col mb-3">
                                           <label class="font-semibold text-gray-600 py-2">subject</label></a> 
                                            <input type="text" name="Subject" placeholder="Subject" required class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" type="text" name="integration[street_address]" id="integration_street_address">
                                            </div>                                            
                                        </div>
